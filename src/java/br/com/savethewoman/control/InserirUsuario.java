...
public class InserirUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        oUser.setNome(request.getParameter("nome"));
        oUser.setTelefone(request.getParameter("telefone"));
        oUser.setSenha(request.getParameter("senha"));
        
        try{
            GenericDAO dao = new UsuarioDAOImpl();
            if (dao.inserir(oUser)) {
            ...
            request.getRequestDispatcher("ListarUsuario").forward(request, response);
                    ...
                    System.out.println("Problemas no servlet SalvarUsuario \n Erro:  " +ex.getMessage());
                    ex.printStackTrace();
        }
    }
