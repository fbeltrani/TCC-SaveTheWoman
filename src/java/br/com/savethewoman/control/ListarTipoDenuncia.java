 ...
 * @author ferbe
 */
@WebServlet(name = "ListarTipoDenuncia", urlPatterns = {"/ListarTipoDenuncia"})
public class ListarTipoDenuncia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("listaTipoDenuncia", dao.listar());
            request.getRequestDispatcher("denuncia.jsp").forward(request, response);
        }catch(Exception ex){
            System.out.println("Erro Servlet ListarTipoDenuncia" +ex.getMessage());
            ex.printStackTrace();
        }
    }
